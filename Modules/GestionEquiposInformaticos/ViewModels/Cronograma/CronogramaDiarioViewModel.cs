...
namespace GestLog.Modules.GestionEquiposInformaticos.ViewModels.Cronograma
{
    ...
    public partial class CronogramaDiarioViewModel : DatabaseAwareViewModel
    {
        ...
        [RelayCommand]        private async Task GestionarPlanesAsync()
        {
            try
            {
                // Abrir diálogo para gestionar planes existentes
                var dialog = new GestLog.Modules.GestionEquiposInformaticos.Views.Cronograma.GestionarPlanesDialog(
        ...
        {            try
            {
                ...
                var dialog = new GestLog.Modules.GestionEquiposInformaticos.Views.Cronograma.CrearPlanCronogramaDialog();
